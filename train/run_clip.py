...
def main():
    ...
    if training_args.do_eval:
        ...
        # Save the confusion matrix and other metrics to output directory
        output_eval_file = os.path.join(training_args.output_dir, "eval_metrics.json")
        with open(output_eval_file, "w") as writer:
            writer.write(json.dumps(metrics, indent=2))

        print(f"Saved evaluation metrics to {output_eval_file}")
